...
public class EditoraRN {
    ...
    /**
     * Acessa o método dao.adicionar de EditoraDAO que por sua vez acessa o
     * método da classe genérica (GenericDAO) salvando a Editora.
     *
     * @param ed Editora.
    ...
    /**
     * Acessa o método dao.listar de EditoraDAO que por sua vez acessa o método
     * da classe genérica (GenericDao) listando as Editoras.
     *
     * @return List(Editora).
     * @see EditoraDAO.
     */
